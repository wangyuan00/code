...
class Course(models.Model):
    ...
    degree = models.CharField(verbose_name=u"难度" , max_length=5, choices=(("cj", "初级"),("zj", "中级"),("gj", "高级")))
...
# 视频，视频和章节是一对多的关系，这里通过设置外键来实现
class Video(models.Model):
    lesson = models.ForeignKey(Lesson, verbose_name=u"章节名")
    name = models.CharField(max_length=100, verbose_name=u"视频名")
    url = models.CharField(max_length=300, verbose_name=u"视频访问", default="")
    learn_times = models.IntegerField(default=30, verbose_name=u"学习时长(分钟数)")
    add_time = models.DateTimeField(default=datetime.now, verbose_name=u"添加时间")
...
class CourseResource(models.Model):
    ...
    download = models.FileField(max_length=100, verbose_name=u"资源文件", upload_to="course/resource/%Y/%m")
    add_time = models.DateTimeField(default=datetime.now, verbose_name=u"添加时间")
